        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-image: linear-gradient(rgba(253, 114, 0, 0.848),rgba(0,0,0,0.75)),url(background.jpg);
...
<body>
    ...
    <footer>
        <center> Designed and Developed by Lokesh reddy A (23007600) </center>
    </footer>
</body>
</html>
    ...
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                ...
                <p> <span>Address</span> : 3/101,Marudhanapalli(vill&post),Krishnagiri-635107 </p>
                <p> <span>Email</span> : lokeshreddy0953@gmail.com </p>
                <p> <span>Phone</span> : 9025800985 </p>
            </div>
        </div>
    </div>
    <footer>
